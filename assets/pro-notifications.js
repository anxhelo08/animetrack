 ...
 async function refresh(){
  ...
  try{
   if(user()){
    ...
    if(!f.error)for(const x of f.data||[])items.push({key:'friend:'+x.id,category:'friends',title:'Kërkesë miqësie',body:'Ke një kërkesë të re për ta shqyrtuar.',at:Date.parse(x.created_at),page:'friends'});
