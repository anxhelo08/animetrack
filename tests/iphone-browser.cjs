...
(async()=>{
 ...
 await page.locator('.at118-result-title[data-id="777"]').waitFor();
 await page.locator('.at118-result-title[data-id="777"]').click();
 ...
 await page.locator('[data-tv-action="resume"][data-id="tvmaze-777"]').click();
 assert(await page.locator('#at118-episode-7771').isVisible(),'Resume must open saved season');
